...
def check(name, index):
    ...
    excpetion_terms = ["ташкилотининг", "чекадилар", "ташкилотининг",
                       ...
                       "исламская республика пакистан", "исламская республика иран", "хаджи"]


    key_terms = ["религ", "мусульман", "ислам", "муфти", "улем", "имам", "мечет", "хиджаб",
     "фатва", "кади", "шейх", "мулл", " отин ", "гадалка", "фолбин", "проповедь", "хутба",
      "тарика", "суфи", "джамаат" "таблигa", "хизб ут-тахрир", "ахмади", "ханафи", "православ",
       "баптист", "свидетели иегов", "мазхаб", "махтаб", "медрес", "мадрас", "муфти",
        "головной платок", "рамадан", "орозо-айт", " курман айт ", " курман-айт ", "байрам", "обрезание", "суннат",
         "паломничеств", "хадж", "хутбе", "хутба", "мазар", "намаз", " джума намаз", " джума-намаз", "халяль", "зикр",
          "даават", "дават", "джихад", "шариа", "кази", "ханафи", "христианин",
        " думк ", "духовное управление мусульман", "государственная комиссия по делам религ", "халал", "халяль"]
    ...
    a[index + 1][1] = which_date(title, data)
    try:
        a[index + 1][2] = a[index + 1][1][0:4]
    except:
        a[index + 1][2] = "N/A"
    a[index + 1][3] = which_law_number(title, data)
    a[index + 1][4] = which_type(title)
    a[index + 1][5] = which_language(title)
